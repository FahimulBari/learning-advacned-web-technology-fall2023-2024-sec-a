...
export const SubscriptionUpdate = ({id}: {id: string})=>{
    ...
    const handleSubmit = async (e:any) => {
        e.preventDefault();
        const Response = await PUTToken(`http://localhost:3000/subscription/update/${id}`,Datas);
    ...
    <div className="max-w-md mx-auto p-6 bg-white3 mb-8">
        <h1 className="text-3xl font-bold text-sky-500 mb-4">Update Subscription</h1>
